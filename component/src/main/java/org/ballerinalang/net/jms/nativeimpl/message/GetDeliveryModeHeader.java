...
public class GetDeliveryModeHeader extends AbstractBlockinAction {
    ...
    public void execute(Context context, CallableUnitCallback callableUnitCallback) {
        ...
        try {
            headerValue = new BInteger(jmsMessage.getJMSDeliveryMode());
        } catch (JMSException e) {
            log.error("Unable to retrieve DeliveryMode from the JMS Message. " + e.getLocalizedMessage());
        }
